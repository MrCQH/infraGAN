...
class Unet_DiscriminatorGenerator(nn.Module):
    def __init__(self, input_nc, output_nc=None, ngf=64, use_dropout=False, resolution=256, gpu_ids=[]):
...
class Unet_Discriminator(nn.Module):
    ...
    def __init__(self, input_c, D_ch=64, D_wide=True, resolution=256, #512,# 256
